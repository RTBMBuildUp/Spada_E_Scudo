...
class Scheduler(_participantMap: ParticipantMap, _currentPhase: Phase, _actionQueue: Queue[(String, ParticipantMap => ParticipantMap)]) {
...
object Scheduler {
  def apply(participantMap: ParticipantMap, currentPhase: Phase, actionQueue: Queue[(String, ParticipantMap => ParticipantMap)] = Queue(Nil: _*)): Scheduler =
